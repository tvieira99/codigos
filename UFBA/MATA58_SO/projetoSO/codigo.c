...
int main() {
  ...
  initFilaDeProcessos();
  initRAM();
  int process1 = initNewProcess(0, 4, 3, 0);
  int process2 = initNewProcess(2, 2, 0, 0);
  //int process3 = initNewProcess(0, 5, 0, 0);
  //int process4 = initNewProcess(0, 2, 0, 0);
  //int process5 = initNewProcess(0, 6, 0, 0);
  //int process6 = initNewProcess(0, 6, 0, 0);
